package com.david.labs.pokedex.framework.adapters.viewholders
...
import com.david.labs.pokedex.domain.PokemonInfoRequirement
    ...
    private fun getPokemonInfo(url: String, imageView: ImageView, context: Context) {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            CoroutineScope(Dispatchers.Main).launch {
                val urlImage =
                    result?.sprites?.other?.official_artwork?.front_default.toString()
